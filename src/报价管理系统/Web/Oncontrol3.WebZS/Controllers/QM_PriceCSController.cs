...
namespace Oncontrol3.Web.Controllers
{
    ...
    public class QM_PriceController : BaseController
    {
        ...
        {
            string sql = @"select RID,ORGNAME from MDM_ORG where SFLG is null AND length(RID)=4 order by RID";
...
SELECT * FROM ( 
       ...
       ORDER BY CREATETIME DESC
        ...
        public ActionResult GetSrvByPrd(string postdata)
        {
            ...
            string sql1 = string.Format("SELECT MDM_SRV_FEE_REF.SRVRQCD121,MDM_SRV_FEE_REF.TCET084,MDM_FEE.TEXTDESC FROM MDM_SRV_FEE_REF LEFT JOIN MDM_FEE ON MDM_SRV_FEE_REF.TCET084 = MDM_FEE.TCET084 WHERE MDM_SRV_FEE_REF.SRVRQCD121 IN  ({0})", feeStr);
        ...
        public ActionResult GetFeeBySrv(string postdata1)
        {
            ...
            string sql = string.Format("SELECT MDM_SRV_FEE_REF.SRVRQCD121,MDM_SRV_FEE_REF.TCET084,MDM_FEE.TEXTDESC FROM MDM_SRV_FEE_REF LEFT JOIN MDM_FEE ON MDM_SRV_FEE_REF.TCET084 = MDM_FEE.TCET084 WHERE MDM_SRV_FEE_REF.SRVRQCD121 IN  {0}", postdata1);
        ...
        public string CODETONAME(string type, string code)
        {
            ...
            switch (type)
            {
                ...
                case "srv":
                    ...
                    break;
                case "fee":
                    var feelist = DataHelper.QueryDictList("SELECT TCET084,TEXTDESC FROM MDM_FEE");
