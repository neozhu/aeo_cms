    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            schBar = new Ext.ux.AimSchPanel({
                ...
                columns: 5,
                items: [
                { fieldLabel: '名称', id: 'BlockName', schopts: { qryopts: "{ mode: 'Like', field: 'BlockName' }"} },
                { fieldLabel: 'Key', id: 'BlockKey', schopts: { qryopts: "{ mode: 'Like', field: 'BlockKey' }"} },
                { fieldLabel: '按钮', xtype: 'button', iconCls: 'aim-icon-search', width: 60, margins: '1 30 0 0', text: '查 询', handler: function() {
                    Ext.ux.AimDoSearch(Ext.getCmp("BlockKey"));
                }
                }
                ]
            });
            ...
            tlBar = new Ext.Toolbar({
                items: [{
                    ...
                    menu: [{ text: '强制刷新新门户', handler: function() {
                        jQuery.ajaxExec('execute', {}, function() {
                            alert("刷新成功！");
                        });
                    }
                    }, { text: '其他操作', handler: function() { viewport.doLayout(); } }]
                }, '->', {
                    text: '复杂查询',
