<%@ Page Title="数据模版" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="SysDataImportTemplateList.aspx.cs" Inherits="Aim.Portal.Web.Modules.SysApp.SiteMag.SysDataImportTemplateList" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            tlBar = new Ext.ux.AimToolbar({
                items: [{
                ...
                }, '-', { text: '导入数据', iconCls: 'aim-icon-db-import', handler: function() {
                    var recs = grid.getSelectionModel().getSelections();
                    if (!recs || recs.length <= 0) {
                    ...
                    ExtGridExportExcel(grid, { store: null, title: '数据导入模版' });
                }
                }, '->', {
                    text: '复杂查询',
