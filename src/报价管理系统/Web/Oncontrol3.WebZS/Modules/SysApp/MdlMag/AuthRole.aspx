<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="AuthRole.aspx.cs" Inherits="Aim.Portal.Web.Modules.SysApp.MdlMag.AuthRole" %>
        ...
        { name: 'Type' }]);
            ...
            store = new Ext.ux.maximgb.tg.AdjacencyListStore({
                ...
                reader: new Ext.ux.data.AimJsonReader({
                    id: 'ID', dsname: 'DtList', aimread: function (rd, resp, dt) {
                        if (dt) {
                            dt = adjustData(dt);
                        }
                    }
            ...
            grid.getSelectionModel().on('rowselect', function (sm, rowIdx, r) {
                if (r.json.Type != "RType") {
                    frameContent.location.href = "AuthTree.aspx?type=role&op=r&id=" + r.json.RoleID + "&Role=" + Role;
                }
            });
