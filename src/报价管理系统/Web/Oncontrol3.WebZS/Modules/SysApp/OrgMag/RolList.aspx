        ...
        function setPgUI() {
            ...
            { id: 'Name', header: '角色类型', width: 100, renderer: roleTypeRender, sortable: true, dataIndex: 'Name' }
                ...
                var schBar = new Ext.ux.AimSchPanel({
                    ...
                    columns: 5,
                    items: [
                { fieldLabel: '角色名', id: 'Name', schopts: { qryopts: "{ mode: 'Like', field: 'Name' }"} },
            ...
            { id: 'Users', header: '相关人员', width: 90, renderer: linkRender, sortable: true, dataIndex: 'Users' },
                ...
                function linkRender(val, p, rec) {
                    ...
                    switch (this.dataIndex) {
                        case "Name":
                            ...
                            break;
                        case "Users":
                            rtn = "<a class='aim-ui-link' onclick=OpenUserSel('" + rec.get("RoleID") + "');>查看/编辑人员</a>";
                            break;
                    }
                ...
                function OpenUserSel(id) {
                    ...
                    jQuery.ajaxExec('getusers', { "id": id }, function(rtn) {
                        if (rtn) {
                            ...
                            url += "&UserID=" + usrIds + "&Name=" + escape(names);
