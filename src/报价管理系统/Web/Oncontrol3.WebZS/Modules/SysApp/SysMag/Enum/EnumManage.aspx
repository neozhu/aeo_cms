<%@ Page Title="系统枚举" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="EnumManage.aspx.cs" Inherits="Aim.Portal.Web.Modules.SysApp.SysMag.EnumManage" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            grid = new Ext.ux.grid.AimEditorTreeGridPanelEx({
                title: '<span style="padding-left:10px;">系统枚举管理</span>',
                store: store,
				...
				{ id: 'SortIndex', dataIndex: 'SortIndex', header: "排序", width: 120, sortable: true },
