...
;(function($) {
    ...
    function install(el, opts) {
        ...
        if (opts.showDialog) {
            arr.push("<table style='-moz-user-select:none;' bgcolor='white' border='0' cellpadding='0' cellspacing='0' width='" + (css.width) + "'>");
            arr.push("  <tr style='cursor:move;'>");
            arr.push("    <td height='20' class=\"ui-widget-header ui-helper-clearfix\" valign=\"bottom\"><div style=\"float:left;font-weight:bold; color:#FFFFFF; padding:9px 2px 2px 4px;\">&nbsp;" + opts.title + "</div>");
            arr.push("      <div style=\"position: relative; cursor:pointer; float:right; height:15px; width:28px; padding:2px; \" drag='false' onClick=\"$.unfunkyUI('" + opts + "');\"><span class=\"ui-icon ui-icon-closethick\"></span></div></td>");
            arr.push("  </tr>");
            ...
            arr.push("              <tr><td width='25' height='50' align='right'><img id='_MessageIcon_" + opts.id + "' width='32' height='32'></td>");
