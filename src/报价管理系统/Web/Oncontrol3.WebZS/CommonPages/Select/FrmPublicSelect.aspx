<%@ Page Title="通用选择组件" Language="C#" MasterPageFile="~/Masters/Mini/Base.Master"
    AutoEventWireup="true" CodeBehind="FrmPublicSelect.aspx.cs" Inherits="CRM.Web.FrmPublicSelect" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            var columns = [
              ...
              { header: "名称", field: "NAME", width: '100%', sortable: true}];
        ...
        function doSearch(domid) {
            grid.reload({ schtype: "field", schdom: document.getElementById(domid), "gettype": $.getQueryString({ ID: "gettype" }),
                "enumcode": $.getQueryString({ ID: "enumcode" })
            });
        }
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="BodyHolder" runat="server">
    <div id="schPanel" style="padding: 5px 10px;">
        <span>名称：</span><input type="text" id="NAME" qryopts="{ mode: 'Like', field: 'NAME' }"
            aimgrp="defgrp" />
        <input type="button" value="查找" onclick="doSearch('NAME')" />
    </div>
