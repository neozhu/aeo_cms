...
<%@ Page Title="标题" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true" CodeBehind="SysSubscribeList.aspx.cs" Inherits="CRM.Web.CommonPages.SysSubscribeList" %>

<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadHolder" runat="server">

<script type="text/javascript">
    var EditWinStyle = CenterWin("width=650,height=600,scrollbars=yes");
    var EditPageUrl = "SYSSUBSCRIBEEdit.aspx";
    ...
    function setPgUI() {
        ...
        myData = {
            ...
            records: AimState["SYSSUBSCRIBEList"] || []
        };

        // 表格数据源
        store = new Ext.ux.data.AimJsonStore({
            dsname: 'SYSSUBSCRIBEList',
            idProperty: 'ID',
            data: myData,
            fields: [
			{ name: 'ID' },
