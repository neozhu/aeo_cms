<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="Aim.Portal.Web.Modules.SysApp.MdlMag.Default" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            grid = new Ext.ux.maximgb.tg.GridPanel({
                title: '<img src="/images/titleicons.gif" style="margin-top:3px;float:left"/><span style="padding-left:10px;">系统入口管理</span>',
                store: store,
                master_column_id: 'Name',
                region: 'center',
                columns: [
				{ id: 'Name', header: "应用 / 模块", width: 200, sortable: true, dataIndex: 'Name' },
				{ header: "编号", width: 160, sortable: true, dataIndex: 'Code' },
				{ header: "序号", width: 40, sortable: true, dataIndex: 'SortIndex' },
