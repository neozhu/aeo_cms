        ...
        if (atype && this.id) {
            switch (atype.toLowerCase()) {
                ...
                case "editor":
                    ...
                    break;
                case "sign":
                    actrl = ((typeof (Aim.Sign) == "undefined") ? null : (new Aim.Sign(this)));
                    break;
            }
...
function initAimUI() {
    ...
    if ($("aim-ui-button-panel").length > 0 && !$("aim-ui-button-panel").css()) {
    ...
    switch (pgOperation) {
        ...
        case "r":
            ...
            $("[class*=aim-ui-td-data]").each(function (i) {
                ...
                //人员选择框,文本化
                $(ttd).find("[aimctrl='user']").each(function (j) {
                    $(this).next().hide().after($(this).val());
                });
