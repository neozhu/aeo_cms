...
<script runat="server">
    ...
    private void Page_Init(object sender, EventArgs e)
    {
        ...
        {
            UploadServiceUrl = Aim.Common.ConfigurationHosting.SystemConfiguration.AppSettings["UploadServiceUrl2"];
        }
        else
        {
            UploadServiceUrl = Aim.Common.ConfigurationHosting.SystemConfiguration.AppSettings["UploadServiceUrl"];
        }
    }
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function FinishUpload() {
            ...
            if (window.opener && window.opener.FinishUpload) {
                window.opener.FinishUpload(files);
            }
...
<body style="height: 100%; margin: 0;">
    ...
    <div id="silverlightControlHost">
        <object id="MultiFileUploader" data="data:application/x-silverlight-2," type="application/x-silverlight-2"
            ...
            <a href="Silverlight.rar" style="text-decoration: none;">
                <img src="InstallSilverlight.png" alt="请下载安装 上传控件" style="border-style: none" />
            </a>
        </object>
