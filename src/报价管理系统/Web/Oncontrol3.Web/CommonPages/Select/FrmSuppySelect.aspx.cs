...
namespace CRM.Web
{
    public partial class FrmSuppySelect : CRMListPage
    {
        public FrmSuppySelect()
        {
            IsCheckLogon = false;
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sql = @"select ID,SUPPLYCODE,CHINANAME as NAME ,ENGLISHNAME,ABBSUPPLY,CASE WHEN nvl(CHINANAME,' ')=' ' then ENGLISHNAME else CHINANAME  END AS CHINANAME,CREATETIME from CRM_SUPPLYBASIC  where " + FilterWhere;
