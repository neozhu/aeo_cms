    ...
    public partial class FEEController : BaseController
    {
        ...
        public ActionResult FEECreate()
        {
            try
            {
                ...
                {
                    sql = @"select distinct DJFSRID,DJFSNAME,FSSORT,SIGHT_FSFYSM from SQM_FEE_PUR_REF where STATUS='1' and FEERID='" + id + "' and FEECODE is not null order by cast(FSSORT as int) asc, DJFSNAME asc";
