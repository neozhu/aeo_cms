...
namespace Oncontrol3.Web.Controllers
{
    ...
    public class QM_SJBJController : BaseController
    {
        ...
        /// <returns></returns>
        public ActionResult SaveSJBJ(string keyvalue, string zversion, string cuscode, string cusname, string busArray, string orgcode, string orgname, string priceName,string priceName_en, string dtfrom, string dtto, string contrsctnum, string memo, string bpcode9,string WAERS)
        {
            var flag = true;
            var rtnmessga = "保存成功";
            string code = "1";
...
WHERE BUSSINESS_ID IN(SELECT ID FROM CRM_BUSINESS WHERE ID IN ({0}))", bizstr.TrimEnd(','));
                ...
                mainobj.BJNAME_EN = priceName_en;//英文报价名称
                mainobj.MEMO = memo;
        ...
        /// <param name="memo"></param>
        /// <returns></returns>
        public ActionResult SaveNEWSJBJ(string cuscode, string cusname, string busArray, string orgcode, string orgname, string priceName,string priceName_en, string dtfrom, string dtto, string contrsctnum, string memo, string bpcode9,string WAERS)
        {
            var data = "";
