...
namespace Aim.Portal.Model
{
    ...
    public partial class SysEnumeration : EditSensitiveTreeNodeEntityBase<SysEnumeration>
    {
        ...
        /// <param name="enums"></param>
        /// <returns></returns>
        public static ArrayList GetEnumComboDatas(string code)
        {
            IEnumerable<SysEnumeration> enums = SysEnumeration.Get(code).ChildNodes;
            ...
            foreach (SysEnumeration item in tenums)
            {
                al.Add(new { Code = item.Value, Name = item.Name });
            }

            return al;
        }

        public static ArrayList GetEnumComboWithBlankDatas(string code)
        {
            IEnumerable<SysEnumeration> enums = SysEnumeration.Get(code).ChildNodes;
            ArrayList al = new ArrayList();
