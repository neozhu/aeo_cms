...
namespace Aim.Portal.Model
{
    ...
    public partial class SysRole : EntityBase<SysRole>, INotifyPropertyChanged
    {
        ...
        public static string Prop_Suporior = "Suporior";
        public static string Prop_CompanyIds = "CompanyIds";
        public static string Prop_CompanyNames = "CompanyNames";
            ...
            string p_companyNames)
        {
            ...
            _suporior = p_suporior;
            _pk_corp = p_pk_corp;
            _companyIds = p_companyIds;
            _companyNames = p_companyNames;
        }
        ...
        [Property("Suporior", Access = PropertyAccess.NosetterCamelcaseUnderscore, Length = 255)]
        public string Suporior
        {
            get { return _suporior; }
            set
            {
                if ((_suporior == null) || (value == null) || (!value.Equals(_suporior)))
                {
                    _suporior = value;
                    NotifyPropertyChanged(SysRole.Prop_Suporior);
                }
            }
        }

        [Property("Pk_corp", Access = PropertyAccess.NosetterCamelcaseUnderscore, Length = 255)]
        public string Pk_corp
        {
            ...
            set
            {
                ...
                {
                    _pk_corp = value;
                    NotifyPropertyChanged(SysRole.Prop_Pk_corp);
                }
            }
        }

        [Property("CompanyIds", Access = PropertyAccess.NosetterCamelcaseUnderscore, Length = 8000)]
        public string CompanyIds
        {
            get { return _companyIds; }
            set
            {
                if ((_companyIds == null) || (value == null) || (!value.Equals(_companyIds)))
                {
                    _companyIds = value;
                    NotifyPropertyChanged(SysRole.Prop_CompanyIds);
                }
            }
        }

        [Property("CompanyNames", Access = PropertyAccess.NosetterCamelcaseUnderscore, Length = 8000)]
        public string CompanyNames
        {
            get { return _companyNames; }
            set
            {
                if ((_companyNames == null) || (value == null) || (!value.Equals(_companyNames)))
                {
                    _companyNames = value;
                    NotifyPropertyChanged(SysRole.Prop_CompanyNames);
                }
            }
        }
        #endregion
