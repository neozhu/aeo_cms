...
namespace Aim.Portal
{
    public class NumberGenerator : CodeGeneratorBase
    {
        ...
        protected CodeGeneratorContext _GeneratorContext = null;

        /// <summary>
        /// 生成对象的上下文
        /// </summary>
        public CodeGeneratorContext GeneratorContext
        {
            get
            {
                if (_GeneratorContext == null)
                {
                    _GeneratorContext = CodeGeneratorService.GetContext();
                }
        ...
        public override string Generate()
        {
            ...
            if (!String.IsNullOrEmpty(TemplateString))
            {
                ...
                vEngine.Evaluate(GeneratorContext, vltWriter, null, TemplateString);
