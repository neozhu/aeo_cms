...
{
	[ActiveRecord("Task")]
    public partial class Task : WFBase<Task>
	{
        ...
        [Property("Flag", Access = PropertyAccess.NosetterCamelcaseUnderscore, Length = 200)]
        public string Flag
        {
            get { return _flag; }
            set
            {
                if ((_flag == null) || (value == null) || (!value.Equals(_flag)))
                {
                    ...
                    _flag = value;
                    RaisePropertyChanged(Task.Prop_Flag, oldValue, value);
                }
            }
        }
        ...
        public string Ext1
        {
            ...
            set
            {
                if ((_ext1 == null) || (value == null) || (!value.Equals(_ext1)))
                {
                    ...
                    _ext1 = value;
                    RaisePropertyChanged(Task.Prop_Ext1, oldValue, value);
                }
            }
        }
        ...
        public string Ext2
        {
            ...
            set
            {
                if ((_ext2 == null) || (value == null) || (!value.Equals(_ext2)))
                {
                    ...
                    _ext2 = value;
                    RaisePropertyChanged(Task.Prop_Ext2, oldValue, value);
                }
            }
        }
