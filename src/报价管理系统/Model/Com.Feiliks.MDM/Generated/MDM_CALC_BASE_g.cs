// Business class MDM_CALC_BASE generated from MDM_CALC_BASE
// Creator: rw
...
{
	[ActiveRecord("MDM_CALC_BASE")]
	public partial class MDM_CALC_BASE : EntityBase<MDM_CALC_BASE>
	{
		...
		public static string Prop_CALC_BASE = "CALC_BASE";
		...
		public string STATUS
		{
			...
			set
			{
				if ((_sTATUS == null) || (value == null) || (!value.Equals(_sTATUS)))
				{
					...
					_sTATUS = value;
					RaisePropertyChanged(MDM_CALC_BASE.Prop_STATUS, oldValue, value);
				}
			}
		}
		...
		public DateTime? CREATETIME
		{
			...
			set
			{
				if (value != _cREATETIME)
				{
					...
					_cREATETIME = value;
					RaisePropertyChanged(MDM_CALC_BASE.Prop_CREATETIME, oldValue, value);
				}
			}
		}
		...
		public string CREATEUSER
		{
			...
			set
			{
				if ((_cREATEUSER == null) || (value == null) || (!value.Equals(_cREATEUSER)))
				{
					...
					_cREATEUSER = value;
					RaisePropertyChanged(MDM_CALC_BASE.Prop_CREATEUSER, oldValue, value);
				}
			}
		}
		...
		public DateTime? MODIFYTIME
		{
			...
			set
			{
				if (value != _mODIFYTIME)
				{
					...
					_mODIFYTIME = value;
					RaisePropertyChanged(MDM_CALC_BASE.Prop_MODIFYTIME, oldValue, value);
				}
			}
		}
		...
		public string MODIFYUSER
		{
			...
			set
			{
				if ((_mODIFYUSER == null) || (value == null) || (!value.Equals(_mODIFYUSER)))
				{
					...
					_mODIFYUSER = value;
					RaisePropertyChanged(MDM_CALC_BASE.Prop_MODIFYUSER, oldValue, value);
				}
			}
		}
		...
		public string MEMO
		{
			...
			set
			{
				if ((_mEMO == null) || (value == null) || (!value.Equals(_mEMO)))
				{
					...
					_mEMO = value;
					RaisePropertyChanged(MDM_CALC_BASE.Prop_MEMO, oldValue, value);
				}
			}
		}
		...
		public string DB_KEY
		{
			...
			set
			{
				if ((_dB_KEY == null) || (value == null) || (!value.Equals(_dB_KEY)))
				{
					...
					_dB_KEY = value;
					RaisePropertyChanged(MDM_CALC_BASE.Prop_DB_KEY, oldValue, value);
				}
			}
		}

		[Property("CALC_BASE", Access = PropertyAccess.NosetterCamelcaseUnderscore, Length = 40)]
		public string CALC_BASE
		{
			get { return _cALC_BASE; }
			set
			{
				if ((_cALC_BASE == null) || (value == null) || (!value.Equals(_cALC_BASE)))
				{
                    object oldValue = _cALC_BASE;
					_cALC_BASE = value;
					RaisePropertyChanged(MDM_CALC_BASE.Prop_CALC_BASE, oldValue, value);
				}
			}
		}
		...
		public string DESCRIPTION
		{
			...
			set
			{
				if ((_dESCRIPTION == null) || (value == null) || (!value.Equals(_dESCRIPTION)))
				{
					...
					_dESCRIPTION = value;
					RaisePropertyChanged(MDM_CALC_BASE.Prop_DESCRIPTION, oldValue, value);
				}
			}
		}
