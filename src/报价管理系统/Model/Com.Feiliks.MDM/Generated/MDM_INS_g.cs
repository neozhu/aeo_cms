// Business class MDM_INS generated from MDM_INS
// Creator: rw
...
{
	[ActiveRecord("MDM_INS")]
	public partial class MDM_INS : EntityBase<MDM_INS>
	{
		...
		public static string Prop_INS_TYPE = "INS_TYPE";
		public static string Prop_INS_ID = "INS_ID";
		public static string Prop_INS_DESCRIPTION = "INS_DESCRIPTION";
		...
		private string _iNS_DESCRIPTION;
			...
			string p_iNS_DESCRIPTION)
		{
			...
			_mEMO = p_mEMO;
			_dB_KEY = p_dB_KEY;
			_iNS_TYPE = p_iNS_TYPE;
			_iNS_ID = p_iNS_ID;
			_iNS_DESCRIPTION = p_iNS_DESCRIPTION;
		}
		...
		public string STATUS
		{
			...
			set
			{
				if ((_sTATUS == null) || (value == null) || (!value.Equals(_sTATUS)))
				{
					...
					_sTATUS = value;
					RaisePropertyChanged(MDM_INS.Prop_STATUS, oldValue, value);
				}
			}
		}
		...
		public DateTime? CREATETIME
		{
			...
			set
			{
				if (value != _cREATETIME)
				{
					...
					_cREATETIME = value;
					RaisePropertyChanged(MDM_INS.Prop_CREATETIME, oldValue, value);
				}
			}
		}
		...
		public string CREATEUSER
		{
			...
			set
			{
				if ((_cREATEUSER == null) || (value == null) || (!value.Equals(_cREATEUSER)))
				{
					...
					_cREATEUSER = value;
					RaisePropertyChanged(MDM_INS.Prop_CREATEUSER, oldValue, value);
				}
			}
		}
		...
		public DateTime? MODIFYTIME
		{
			...
			set
			{
				if (value != _mODIFYTIME)
				{
					...
					_mODIFYTIME = value;
					RaisePropertyChanged(MDM_INS.Prop_MODIFYTIME, oldValue, value);
				}
			}
		}
		...
		public string MODIFYUSER
		{
			...
			set
			{
				if ((_mODIFYUSER == null) || (value == null) || (!value.Equals(_mODIFYUSER)))
				{
					...
					_mODIFYUSER = value;
					RaisePropertyChanged(MDM_INS.Prop_MODIFYUSER, oldValue, value);
				}
			}
		}
		...
		public string MEMO
		{
			...
			set
			{
				if ((_mEMO == null) || (value == null) || (!value.Equals(_mEMO)))
				{
					...
					_mEMO = value;
					RaisePropertyChanged(MDM_INS.Prop_MEMO, oldValue, value);
				}
			}
		}
		...
		public string DB_KEY
		{
			...
			set
			{
				if ((_dB_KEY == null) || (value == null) || (!value.Equals(_dB_KEY)))
				{
					...
					_dB_KEY = value;
					RaisePropertyChanged(MDM_INS.Prop_DB_KEY, oldValue, value);
				}
			}
		}

		[Property("INS_TYPE", Access = PropertyAccess.NosetterCamelcaseUnderscore, Length = 40)]
		public string INS_TYPE
		{
			get { return _iNS_TYPE; }
			set
			{
				if ((_iNS_TYPE == null) || (value == null) || (!value.Equals(_iNS_TYPE)))
				{
                    object oldValue = _iNS_TYPE;
					_iNS_TYPE = value;
					RaisePropertyChanged(MDM_INS.Prop_INS_TYPE, oldValue, value);
				}
			}
		}
		...
		public string INS_ID
		{
			...
			set
			{
				if ((_iNS_ID == null) || (value == null) || (!value.Equals(_iNS_ID)))
				{
					...
					_iNS_ID = value;
					RaisePropertyChanged(MDM_INS.Prop_INS_ID, oldValue, value);
				}
			}
		}

		[Property("INS_DESCRIPTION", Access = PropertyAccess.NosetterCamelcaseUnderscore, Length = 200)]
		public string INS_DESCRIPTION
		{
			get { return _iNS_DESCRIPTION; }
			set
			{
				if ((_iNS_DESCRIPTION == null) || (value == null) || (!value.Equals(_iNS_DESCRIPTION)))
				{
                    object oldValue = _iNS_DESCRIPTION;
					_iNS_DESCRIPTION = value;
					RaisePropertyChanged(MDM_INS.Prop_INS_DESCRIPTION, oldValue, value);
				}
			}
		}
