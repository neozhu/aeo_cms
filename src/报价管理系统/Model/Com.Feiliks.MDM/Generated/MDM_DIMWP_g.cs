// Business class MDM_DIMWP generated from MDM_DIMWP
// Creator: rw
...
{
	[ActiveRecord("MDM_DIMWP")]
	public partial class MDM_DIMWP : EntityBase<MDM_DIMWP>
	{
		...
		public string STATUS
		{
			...
			set
			{
				if ((_sTATUS == null) || (value == null) || (!value.Equals(_sTATUS)))
				{
					...
					_sTATUS = value;
					RaisePropertyChanged(MDM_DIMWP.Prop_STATUS, oldValue, value);
				}
			}
		}
		...
		public DateTime? CREATETIME
		{
			...
			set
			{
				if (value != _cREATETIME)
				{
					...
					_cREATETIME = value;
					RaisePropertyChanged(MDM_DIMWP.Prop_CREATETIME, oldValue, value);
				}
			}
		}
		...
		public string CREATEUSER
		{
			...
			set
			{
				if ((_cREATEUSER == null) || (value == null) || (!value.Equals(_cREATEUSER)))
				{
					...
					_cREATEUSER = value;
					RaisePropertyChanged(MDM_DIMWP.Prop_CREATEUSER, oldValue, value);
				}
			}
		}
		...
		public DateTime? MODIFYTIME
		{
			...
			set
			{
				if (value != _mODIFYTIME)
				{
					...
					_mODIFYTIME = value;
					RaisePropertyChanged(MDM_DIMWP.Prop_MODIFYTIME, oldValue, value);
				}
			}
		}
		...
		public string MODIFYUSER
		{
			...
			set
			{
				if ((_mODIFYUSER == null) || (value == null) || (!value.Equals(_mODIFYUSER)))
				{
					...
					_mODIFYUSER = value;
					RaisePropertyChanged(MDM_DIMWP.Prop_MODIFYUSER, oldValue, value);
				}
			}
		}
		...
		public string MEMO
		{
			...
			set
			{
				if ((_mEMO == null) || (value == null) || (!value.Equals(_mEMO)))
				{
					...
					_mEMO = value;
					RaisePropertyChanged(MDM_DIMWP.Prop_MEMO, oldValue, value);
				}
			}
		}
		...
		public string DB_KEY
		{
			...
			set
			{
				if ((_dB_KEY == null) || (value == null) || (!value.Equals(_dB_KEY)))
				{
					...
					_dB_KEY = value;
					RaisePropertyChanged(MDM_DIMWP.Prop_DB_KEY, oldValue, value);
				}
			}
		}

		[Property("ID", Access = PropertyAccess.NosetterCamelcaseUnderscore, Length = 40)]
		public string ID
		{
			get { return _iD; }
			set
			{
				if ((_iD == null) || (value == null) || (!value.Equals(_iD)))
				{
                    object oldValue = _iD;
					_iD = value;
					RaisePropertyChanged(MDM_DIMWP.Prop_ID, oldValue, value);
				}
			}
		}
		...
		public string DESCRIPTION
		{
			...
			set
			{
				if ((_dESCRIPTION == null) || (value == null) || (!value.Equals(_dESCRIPTION)))
				{
					...
					_dESCRIPTION = value;
					RaisePropertyChanged(MDM_DIMWP.Prop_DESCRIPTION, oldValue, value);
				}
			}
		}
