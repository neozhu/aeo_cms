// Business class MDM_SRV_FEE_REF generated from MDM_SRV_FEE_REF
// Creator: rw
...
{
	[ActiveRecord("MDM_SRV_FEE_REF")]
	public partial class MDM_SRV_FEE_REF : EntityBase<MDM_SRV_FEE_REF>
	{
		...
		public string STATUS
		{
			...
			set
			{
				if ((_sTATUS == null) || (value == null) || (!value.Equals(_sTATUS)))
				{
					...
					_sTATUS = value;
					RaisePropertyChanged(MDM_SRV_FEE_REF.Prop_STATUS, oldValue, value);
				}
			}
		}
		...
		public DateTime? CREATETIME
		{
			...
			set
			{
				if (value != _cREATETIME)
				{
					...
					_cREATETIME = value;
					RaisePropertyChanged(MDM_SRV_FEE_REF.Prop_CREATETIME, oldValue, value);
				}
			}
		}
		...
		public string CREATEUSER
		{
			...
			set
			{
				if ((_cREATEUSER == null) || (value == null) || (!value.Equals(_cREATEUSER)))
				{
					...
					_cREATEUSER = value;
					RaisePropertyChanged(MDM_SRV_FEE_REF.Prop_CREATEUSER, oldValue, value);
				}
			}
		}
		...
		public DateTime? MODIFYTIME
		{
			...
			set
			{
				if (value != _mODIFYTIME)
				{
					...
					_mODIFYTIME = value;
					RaisePropertyChanged(MDM_SRV_FEE_REF.Prop_MODIFYTIME, oldValue, value);
				}
			}
		}
		...
		public string MODIFYUSER
		{
			...
			set
			{
				if ((_mODIFYUSER == null) || (value == null) || (!value.Equals(_mODIFYUSER)))
				{
					...
					_mODIFYUSER = value;
					RaisePropertyChanged(MDM_SRV_FEE_REF.Prop_MODIFYUSER, oldValue, value);
				}
			}
		}
		...
		public string MEMO
		{
			...
			set
			{
				if ((_mEMO == null) || (value == null) || (!value.Equals(_mEMO)))
				{
					...
					_mEMO = value;
					RaisePropertyChanged(MDM_SRV_FEE_REF.Prop_MEMO, oldValue, value);
				}
			}
		}
		...
		public string DB_KEY
		{
			...
			set
			{
				if ((_dB_KEY == null) || (value == null) || (!value.Equals(_dB_KEY)))
				{
					...
					_dB_KEY = value;
					RaisePropertyChanged(MDM_SRV_FEE_REF.Prop_DB_KEY, oldValue, value);
				}
			}
		}
		...
		public string TCET084
		{
			...
			set
			{
				if ((_tCET084 == null) || (value == null) || (!value.Equals(_tCET084)))
				{
					...
					_tCET084 = value;
					RaisePropertyChanged(MDM_SRV_FEE_REF.Prop_TCET084, oldValue, value);
				}
			}
		}
		...
		public string SRVRQCD121
		{
			...
			set
			{
				if ((_sRVRQCD121 == null) || (value == null) || (!value.Equals(_sRVRQCD121)))
				{
					...
					_sRVRQCD121 = value;
					RaisePropertyChanged(MDM_SRV_FEE_REF.Prop_SRVRQCD121, oldValue, value);
				}
			}
		}
