// Business class MDM_CALC_BASIC generated from MDM_CALC_BASIC
// Creator: rw
...
{
	[ActiveRecord("MDM_CALC_BASIC")]
	public partial class MDM_CALC_BASIC : EntityBase<MDM_CALC_BASIC>
	{
		...
		public string MDNAME
		{
			...
			set
			{
				if ((_mDNAME == null) || (value == null) || (!value.Equals(_mDNAME)))
				{
					...
					_mDNAME = value;
					RaisePropertyChanged(MDM_CALC_BASIC.Prop_MDNAME, oldValue, value);
				}
			}
		}
		...
		public string MDTYPE
		{
			...
			set
			{
				if ((_mDTYPE == null) || (value == null) || (!value.Equals(_mDTYPE)))
				{
					...
					_mDTYPE = value;
					RaisePropertyChanged(MDM_CALC_BASIC.Prop_MDTYPE, oldValue, value);
				}
			}
		}
		...
		public DateTime? CREATETIME
		{
			...
			set
			{
				if (value != _cREATETIME)
				{
					...
					_cREATETIME = value;
					RaisePropertyChanged(MDM_CALC_BASIC.Prop_CREATETIME, oldValue, value);
				}
			}
		}
		...
		public string CREATEUSER
		{
			...
			set
			{
				if ((_cREATEUSER == null) || (value == null) || (!value.Equals(_cREATEUSER)))
				{
					...
					_cREATEUSER = value;
					RaisePropertyChanged(MDM_CALC_BASIC.Prop_CREATEUSER, oldValue, value);
				}
			}
		}
		...
		public DateTime? MODIFYTIME
		{
			...
			set
			{
				if (value != _mODIFYTIME)
				{
					...
					_mODIFYTIME = value;
					RaisePropertyChanged(MDM_CALC_BASIC.Prop_MODIFYTIME, oldValue, value);
				}
			}
		}
		...
		public string MODIFYUSER
		{
			...
			set
			{
				if ((_mODIFYUSER == null) || (value == null) || (!value.Equals(_mODIFYUSER)))
				{
					...
					_mODIFYUSER = value;
					RaisePropertyChanged(MDM_CALC_BASIC.Prop_MODIFYUSER, oldValue, value);
				}
			}
		}
		...
		public string RID
		{
			...
			set
			{
				if ((_rID == null) || (value == null) || (!value.Equals(_rID)))
				{
					...
					_rID = value;
					RaisePropertyChanged(MDM_CALC_BASIC.Prop_RID, oldValue, value);
				}
			}
		}
        //[XmlIgnore]
		...
		public string STATUS
		{
			...
			set
			{
				if ((_sTATUS == null) || (value == null) || (!value.Equals(_sTATUS)))
				{
					...
					_sTATUS = value;
					RaisePropertyChanged(MDM_CALC_BASIC.Prop_STATUS, oldValue, value);
				}
			}
		}
        //[XmlIgnore]
		...
		public string MEMO
		{
			...
			set
			{
				if ((_mEMO == null) || (value == null) || (!value.Equals(_mEMO)))
				{
					...
					_mEMO = value;
					RaisePropertyChanged(MDM_CALC_BASIC.Prop_MEMO, oldValue, value);
				}
			}
		}
