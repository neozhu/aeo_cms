// Business class MDM_CALC_STRC generated from MDM_CALC_STRC
// Creator: rw
...
{
	[ActiveRecord("MDM_CALC_STRC")]
	public partial class MDM_CALC_STRC : EntityBase<MDM_CALC_STRC>
	{
		...
		public string MDKEY
		{
			...
			set
			{
				if ((_mDKEY == null) || (value == null) || (!value.Equals(_mDKEY)))
				{
					...
					_mDKEY = value;
					RaisePropertyChanged(MDM_CALC_STRC.Prop_MDKEY, oldValue, value);
				}
			}
		}
		...
		public string TABNAME
		{
			...
			set
			{
				if ((_tABNAME == null) || (value == null) || (!value.Equals(_tABNAME)))
				{
					...
					_tABNAME = value;
					RaisePropertyChanged(MDM_CALC_STRC.Prop_TABNAME, oldValue, value);
				}
			}
		}
		...
		public string FIELDNAME
		{
			...
			set
			{
				if ((_fIELDNAME == null) || (value == null) || (!value.Equals(_fIELDNAME)))
				{
					...
					_fIELDNAME = value;
					RaisePropertyChanged(MDM_CALC_STRC.Prop_FIELDNAME, oldValue, value);
				}
			}
		}
		...
		public string KEYFLAG
		{
			...
			set
			{
				if ((_kEYFLAG == null) || (value == null) || (!value.Equals(_kEYFLAG)))
				{
					...
					_kEYFLAG = value;
					RaisePropertyChanged(MDM_CALC_STRC.Prop_KEYFLAG, oldValue, value);
				}
			}
		}
		...
		public System.Decimal? POSITION
		{
			...
			set
			{
				if (value != _pOSITION)
				{
					...
					_pOSITION = value;
					RaisePropertyChanged(MDM_CALC_STRC.Prop_POSITION, oldValue, value);
				}
			}
		}
		...
		public string INTTYPE
		{
			...
			set
			{
				if ((_iNTTYPE == null) || (value == null) || (!value.Equals(_iNTTYPE)))
				{
					...
					_iNTTYPE = value;
					RaisePropertyChanged(MDM_CALC_STRC.Prop_INTTYPE, oldValue, value);
				}
			}
		}
		...
		public System.Decimal? INTLEN
		{
			...
			set
			{
				if (value != _iNTLEN)
				{
					...
					_iNTLEN = value;
					RaisePropertyChanged(MDM_CALC_STRC.Prop_INTLEN, oldValue, value);
				}
			}
		}
		...
		public string DDLANGUAGE
		{
			...
			set
			{
				if ((_dDLANGUAGE == null) || (value == null) || (!value.Equals(_dDLANGUAGE)))
				{
					...
					_dDLANGUAGE = value;
					RaisePropertyChanged(MDM_CALC_STRC.Prop_DDLANGUAGE, oldValue, value);
				}
			}
		}
		...
		public string DDTEXT
		{
			...
			set
			{
				if ((_dDTEXT == null) || (value == null) || (!value.Equals(_dDTEXT)))
				{
					...
					_dDTEXT = value;
					RaisePropertyChanged(MDM_CALC_STRC.Prop_DDTEXT, oldValue, value);
				}
			}
		}
		...
		public DateTime? CREATETIME
		{
			...
			set
			{
				if (value != _cREATETIME)
				{
					...
					_cREATETIME = value;
					RaisePropertyChanged(MDM_CALC_STRC.Prop_CREATETIME, oldValue, value);
				}
			}
		}
        //[XmlIgnore]
		...
		public string CREATEUSER
		{
			...
			set
			{
				if ((_cREATEUSER == null) || (value == null) || (!value.Equals(_cREATEUSER)))
				{
					...
					_cREATEUSER = value;
					RaisePropertyChanged(MDM_CALC_STRC.Prop_CREATEUSER, oldValue, value);
				}
			}
		}
        //[XmlIgnore]
		...
		public DateTime? MODIFYTIME
		{
			...
			set
			{
				if (value != _mODIFYTIME)
				{
					...
					_mODIFYTIME = value;
					RaisePropertyChanged(MDM_CALC_STRC.Prop_MODIFYTIME, oldValue, value);
				}
			}
		}
        //[XmlIgnore]
		...
		public string MODIFYUSER
		{
			...
			set
			{
				if ((_mODIFYUSER == null) || (value == null) || (!value.Equals(_mODIFYUSER)))
				{
					...
					_mODIFYUSER = value;
					RaisePropertyChanged(MDM_CALC_STRC.Prop_MODIFYUSER, oldValue, value);
				}
			}
		}
        //[XmlIgnore]
		...
		public string STATUS
		{
			...
			set
			{
				if ((_sTATUS == null) || (value == null) || (!value.Equals(_sTATUS)))
				{
					...
					_sTATUS = value;
					RaisePropertyChanged(MDM_CALC_STRC.Prop_STATUS, oldValue, value);
				}
			}
		}
        //[XmlIgnore]
		...
		public string MEMO
		{
			...
			set
			{
				if ((_mEMO == null) || (value == null) || (!value.Equals(_mEMO)))
				{
					...
					_mEMO = value;
					RaisePropertyChanged(MDM_CALC_STRC.Prop_MEMO, oldValue, value);
				}
			}
		}
