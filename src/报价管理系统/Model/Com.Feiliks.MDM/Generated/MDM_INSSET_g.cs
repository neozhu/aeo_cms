// Business class MDM_INSSET generated from MDM_INSSET
// Creator: rw
...
{
	[ActiveRecord("MDM_INSSET")]
	public partial class MDM_INSSET : EntityBase<MDM_INSSET>
	{
		...
		public static string Prop_INSSET_DESC = "INSSET_DESC";
		...
		public string STATUS
		{
			...
			set
			{
				if ((_sTATUS == null) || (value == null) || (!value.Equals(_sTATUS)))
				{
					...
					_sTATUS = value;
					RaisePropertyChanged(MDM_INSSET.Prop_STATUS, oldValue, value);
				}
			}
		}
		...
		public DateTime? CREATETIME
		{
			...
			set
			{
				if (value != _cREATETIME)
				{
					...
					_cREATETIME = value;
					RaisePropertyChanged(MDM_INSSET.Prop_CREATETIME, oldValue, value);
				}
			}
		}
		...
		public string CREATEUSER
		{
			...
			set
			{
				if ((_cREATEUSER == null) || (value == null) || (!value.Equals(_cREATEUSER)))
				{
					...
					_cREATEUSER = value;
					RaisePropertyChanged(MDM_INSSET.Prop_CREATEUSER, oldValue, value);
				}
			}
		}
		...
		public DateTime? MODIFYTIME
		{
			...
			set
			{
				if (value != _mODIFYTIME)
				{
					...
					_mODIFYTIME = value;
					RaisePropertyChanged(MDM_INSSET.Prop_MODIFYTIME, oldValue, value);
				}
			}
		}
		...
		public string MODIFYUSER
		{
			...
			set
			{
				if ((_mODIFYUSER == null) || (value == null) || (!value.Equals(_mODIFYUSER)))
				{
					...
					_mODIFYUSER = value;
					RaisePropertyChanged(MDM_INSSET.Prop_MODIFYUSER, oldValue, value);
				}
			}
		}
		...
		public string MEMO
		{
			...
			set
			{
				if ((_mEMO == null) || (value == null) || (!value.Equals(_mEMO)))
				{
					...
					_mEMO = value;
					RaisePropertyChanged(MDM_INSSET.Prop_MEMO, oldValue, value);
				}
			}
		}
		...
		public string DB_KEY
		{
			...
			set
			{
				if ((_dB_KEY == null) || (value == null) || (!value.Equals(_dB_KEY)))
				{
					...
					_dB_KEY = value;
					RaisePropertyChanged(MDM_INSSET.Prop_DB_KEY, oldValue, value);
				}
			}
		}
		...
		public string INSSET_ID
		{
			...
			set
			{
				if ((_iNSSET_ID == null) || (value == null) || (!value.Equals(_iNSSET_ID)))
				{
					...
					_iNSSET_ID = value;
					RaisePropertyChanged(MDM_INSSET.Prop_INSSET_ID, oldValue, value);
				}
			}
		}

		[Property("INSSET_DESC", Access = PropertyAccess.NosetterCamelcaseUnderscore, Length = 200)]
		public string INSSET_DESC
		{
			get { return _iNSSET_DESC; }
			set
			{
				if ((_iNSSET_DESC == null) || (value == null) || (!value.Equals(_iNSSET_DESC)))
				{
                    object oldValue = _iNSSET_DESC;
					_iNSSET_DESC = value;
					RaisePropertyChanged(MDM_INSSET.Prop_INSSET_DESC, oldValue, value);
				}
			}
		}
