...
{
/// <summary>
/// File: ICustomerInvoiceService.cs
...
/// </summary>
    public interface ICustomerInvoiceService:IService<CustomerInvoice>
    {
         Task<IEnumerable<CustomerInvoice>> GetByCustomerIdAsync(int  customerid);
