...
{
/// <summary>
/// File: ICustomerWarehouseService.cs
...
/// </summary>
    public interface ICustomerWarehouseService:IService<CustomerWarehouse>
    {
         Task<IEnumerable<CustomerWarehouse>> GetByCustomerIdAsync(int  customerid);
