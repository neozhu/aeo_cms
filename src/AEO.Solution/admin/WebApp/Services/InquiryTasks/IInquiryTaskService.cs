...
/// </summary>
    public interface IInquiryTaskService:IService<InquiryTask>
    {
         Task<IEnumerable<InquiryTask>> GetByCompanyIdAsync(int  companyid);
         Task<IEnumerable<InquiryTask>> GetByCustomerIdAsync(int  customerid);
         Task<IEnumerable<InquiryTaskProduct>>   GetInquiryTaskProductsByInquiryTaskIdAsync (int inquirytaskid);
