...
{
/// <summary>
/// File: IInquiryTaskProductService.cs
...
/// </summary>
    public interface IInquiryTaskProductService:IService<InquiryTaskProduct>
    {
         Task<IEnumerable<InquiryTaskProduct>> GetByInquiryTaskIdAsync(int  inquirytaskid);
    ...
    string UploadPicture(int id, HttpPostedFileBase file, string folder, string relpath);
    }
}