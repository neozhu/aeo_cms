...
{
/// <summary>
/// File: IProductPurchaseHistoricalPriceService.cs
...
/// </summary>
    public interface IProductPurchaseHistoricalPriceService:IService<ProductPurchaseHistoricalPrice>
    {
         Task<IEnumerable<ProductPurchaseHistoricalPrice>> GetByProductIdAsync(int  productid);
