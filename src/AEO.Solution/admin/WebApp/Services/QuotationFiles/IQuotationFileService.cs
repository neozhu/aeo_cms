...
/// </summary>
    public interface IQuotationFileService:IService<QuotationFile>
    {
         Task<IEnumerable<QuotationFile>> GetByQuotationIdAsync(int  quotationid);
    ...
    void AddFile(int ver, int quotationid, string qpno, HttpPostedFileBase file, string folder, string relpath, string user);
  }
}