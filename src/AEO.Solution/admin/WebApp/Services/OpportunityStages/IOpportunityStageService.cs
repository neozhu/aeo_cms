...
{
/// <summary>
/// File: IOpportunityStageService.cs
...
/// </summary>
    public interface IOpportunityStageService:IService<OpportunityStage>
    {
         Task<IEnumerable<OpportunityStage>> GetByBusinessOpportunityIdAsync(int  businessopportunityid);
