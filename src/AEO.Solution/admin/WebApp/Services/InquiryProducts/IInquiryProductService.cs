...
{
/// <summary>
/// File: IInquiryProductService.cs
...
/// </summary>
    public interface IInquiryProductService:IService<InquiryProduct>
    {
         Task<IEnumerable<InquiryProduct>> GetByInquiryIdAsync(int  inquiryid);
