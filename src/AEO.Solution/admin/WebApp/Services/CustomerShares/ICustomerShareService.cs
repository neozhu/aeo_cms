...
/// </summary>
    public interface ICustomerShareService:IService<CustomerShare>
    {
         Task<IEnumerable<CustomerShare>> GetByCustomerIdAsync(int  customerid);
