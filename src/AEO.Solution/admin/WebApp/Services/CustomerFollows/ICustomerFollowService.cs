...
{
/// <summary>
/// File: ICustomerFollowService.cs
...
/// </summary>
    public interface ICustomerFollowService:IService<CustomerFollow>
    {
         Task<IEnumerable<CustomerFollow>> GetByCustomerIdAsync(int  customerid);
