...
{
/// <summary>
/// File: IBusinessOpportunityService.cs
...
/// </summary>
    public interface IBusinessOpportunityService:IService<BusinessOpportunity>
    {
         Task<IEnumerable<BusinessOpportunity>> GetByCustomerIdAsync(int  customerid);
