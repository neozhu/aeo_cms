...
{
/// <summary>
/// File: IProductSalesHistoricalPriceService.cs
...
/// </summary>
    public interface IProductSalesHistoricalPriceService:IService<ProductSalesHistoricalPrice>
    {
         Task<IEnumerable<ProductSalesHistoricalPrice>> GetByProductIdAsync(int  productid);
