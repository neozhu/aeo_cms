...
/// </summary>
    public interface ICustomerSalesService:IService<CustomerSales>
    {
         Task<IEnumerable<CustomerSales>> GetByCustomerIdAsync(int  customerid);
