...
/// Created Date: 2020/7/30 12:00:00
/// Author: neo.zhu
...
/// </summary>
    public class CategoryService : Service< Category >, ICategoryService
    {
            ...
            : base(repository)
        {
            ...
            this.logger = logger;
                 ...
                 public async  Task<IEnumerable<Category>> GetByParentIdAsync(int  parentid) => await repository.GetByParentIdAsync(parentid);
                    ...
                    foreach (var field in mapping)
                    {
                        ...
                        )
						{
                            ...
                            switch (field.FieldName) {
                                                                 case "ParentId":
                                     var category_name =  row[field.SourceFieldName].ToString();
                                     var parentid = await this.getParentIdByNameAsync(category_name);
				...
				public async Task<Stream> ExportExcelAsync(string filterRules = "",string sort = "Id", string order = "asc")
        {
            ...
            var categories  = await this.Query(new CategoryQuery().Withfilter(filters)).Include(p => p.Parent).OrderBy(n=>n.OrderBy(sort,order)).SelectAsync();
    ...
    ParentId = n.ParentId
            ...
            return await NPOIHelper.ExportExcelAsync("产品类别", datarows,expcolopts);
        }
