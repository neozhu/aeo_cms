...
{
/// <summary>
/// File: ICustomerAttentionProductService.cs
...
/// </summary>
    public interface ICustomerAttentionProductService:IService<CustomerAttentionProduct>
    {
         Task<IEnumerable<CustomerAttentionProduct>> GetByCustomerIdAsync(int  customerid);
