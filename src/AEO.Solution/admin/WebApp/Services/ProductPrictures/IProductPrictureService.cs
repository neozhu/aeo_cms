...
{
/// <summary>
/// File: IProductPrictureService.cs
...
/// </summary>
    public interface IProductPrictureService:IService<ProductPricture>
    {
         Task<IEnumerable<ProductPricture>> GetByProductIdAsync(int  productid);
