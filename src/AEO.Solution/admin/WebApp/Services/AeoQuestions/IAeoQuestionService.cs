...
/// </summary>
    public interface IAeoQuestionService:IService<AeoQuestion>
    {
         Task<IEnumerable<AeoQuestion>> GetByAeoAuthTestIdAsync(int  aeoauthtestid);
