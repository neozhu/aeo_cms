...
/// </summary>
    public interface IQuotationService:IService<Quotation>
    {
         ...
         Task<IEnumerable<QuotationFile>>   GetQuotationFilesByQuotationIdAsync (int quotationid);
         Task<IEnumerable<QuotationProduct>>   GetQuotationProductsByQuotationIdAsync (int quotationid);
