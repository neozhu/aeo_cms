...
{
/// <summary>
/// File: IQuotationChargeService.cs
...
/// </summary>
    public interface IQuotationChargeService:IService<QuotationCharge>
    {
         Task<IEnumerable<QuotationCharge>> GetByQuotationIdAsync(int  quotationid);
