...
{
/// <summary>
/// File: ICustomerCommunicationService.cs
...
/// </summary>
    public interface ICustomerCommunicationService:IService<CustomerCommunication>
    {
         Task<IEnumerable<CustomerCommunication>> GetByCustomerIdAsync(int  customerid);
