...
{
/// <summary>
/// File: IQuotationProductService.cs
...
/// </summary>
    public interface IQuotationProductService:IService<QuotationProduct>
    {
         Task<IEnumerable<QuotationProduct>> GetByQuotationIdAsync(int  quotationid);
