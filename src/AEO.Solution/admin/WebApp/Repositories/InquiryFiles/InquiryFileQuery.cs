...
/// </summary>
   public class InquiryFileQuery:QueryObject<InquiryFile>
   {
		public InquiryFileQuery Withfilter(IEnumerable<filterRule> filters)
        {
           if (filters != null)
           {
         ...
         public  InquiryFileQuery ByInquiryIdWithfilter(int inquiryid, IEnumerable<filterRule> filters)
         {
