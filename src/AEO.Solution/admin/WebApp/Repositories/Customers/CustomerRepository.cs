  ...
  public static class CustomerRepository  
    {
          ...
          => await  repository.GetRepositoryAsync<CustomerBank>()
                ...
                public static async Task<IEnumerable<CustomerCommunication>>   GetCustomerCommunicationsByCustomerIdAsync (this IRepositoryAsync<Customer> repository,int customerid)
          => await  repository.GetRepositoryAsync<CustomerCommunication>()
                    .Queryable()
                    .Include(x => x.Customer)
                    .Where(n => n.CustomerId == customerid)
                    .ToListAsync();
          ...
          => await  repository.GetRepositoryAsync<CustomerFollow>()
                ...
                public static async Task<IEnumerable<CustomerInvoice>>   GetCustomerInvoicesByCustomerIdAsync (this IRepositoryAsync<Customer> repository,int customerid)
          => await  repository.GetRepositoryAsync<CustomerInvoice>()
                    .Queryable()
                    .Include(x => x.Customer)
                    .Where(n => n.CustomerId == customerid)
                    .ToListAsync();
