...
/// Created Date: 2020/7/3 13:55:09
/// Author: neo.zhu
		...
		public CustomerContactQuery Withfilter(IEnumerable<filterRule> filters)
        {
           if (filters != null)
           {
               foreach (var rule in filters)
               {
						...
						if (rule.field == "Duty"  && !string.IsNullOrEmpty(rule.value))
						{
							And(x => x.Duty.Contains(rule.value));
						}
						if (rule.field == "MobilePhone"  && !string.IsNullOrEmpty(rule.value))
						{
							And(x => x.MobilePhone.Contains(rule.value));
						}
						if (rule.field == "PhoneNumber1"  && !string.IsNullOrEmpty(rule.value))
						{
							And(x => x.PhoneNumber1.Contains(rule.value));
						}
						if (rule.field == "PhoneNumber2"  && !string.IsNullOrEmpty(rule.value))
						{
							And(x => x.PhoneNumber2.Contains(rule.value));
						}
						if (rule.field == "PhoneNumber3"  && !string.IsNullOrEmpty(rule.value))
						{
							And(x => x.PhoneNumber3.Contains(rule.value));
						}
            ...
            if (filters != null)
           {
               ...
               {     
						...
						if (rule.field == "PhoneNumber1"  && !string.IsNullOrEmpty(rule.value))
						{
                           if (rule.op == "equal")
                           {
                             And(x => x.PhoneNumber1 == rule.value);
                           } 
                           else
                           {
							And(x => x.PhoneNumber1.Contains(rule.value));
						...
						if (rule.field == "PhoneNumber2"  && !string.IsNullOrEmpty(rule.value))
						{
                           if (rule.op == "equal")
                           {
                             And(x => x.PhoneNumber2 == rule.value);
                           } 
                           else
                           {
							And(x => x.PhoneNumber2.Contains(rule.value));
						...
						if (rule.field == "PhoneNumber3"  && !string.IsNullOrEmpty(rule.value))
						{
                           if (rule.op == "equal")
                           {
                             And(x => x.PhoneNumber3 == rule.value);
                           } 
                           else
                           {
							And(x => x.PhoneNumber3.Contains(rule.value));
