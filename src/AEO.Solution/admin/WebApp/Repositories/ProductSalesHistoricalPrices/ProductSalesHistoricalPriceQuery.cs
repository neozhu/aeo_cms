...
{
/// <summary>
/// File: ProductSalesHistoricalPriceQuery.cs
/// Purpose: easyui datagrid filter query 
/// Created Date: 2020/7/30 16:27:46
/// Author: neo.zhu
/// Tools: SmartCode MVC5 Scaffolder for Visual Studio 2017
/// Copyright (c) 2012-2018 All Rights Reserved
/// </summary>
   public class ProductSalesHistoricalPriceQuery:QueryObject<ProductSalesHistoricalPrice>
   {
		public ProductSalesHistoricalPriceQuery Withfilter(IEnumerable<filterRule> filters)
        {
           if (filters != null)
           {
         ...
         public  ProductSalesHistoricalPriceQuery ByProductIdWithfilter(int productid, IEnumerable<filterRule> filters)
         {
