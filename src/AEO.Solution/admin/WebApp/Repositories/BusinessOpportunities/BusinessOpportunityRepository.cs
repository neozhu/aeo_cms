...
{
/// <summary>
/// File: BusinessOpportunityRepository.cs
...
/// </summary>
  public static class BusinessOpportunityRepository  
    {
                 public static async Task<IEnumerable<BusinessOpportunity>> GetByCustomerIdAsync(this IRepositoryAsync<BusinessOpportunity> repository, int customerid)
          => await repository
                .Queryable()
