...
/// </summary>
   public class QuotationFileQuery:QueryObject<QuotationFile>
   {
		public QuotationFileQuery Withfilter(IEnumerable<filterRule> filters)
        {
           if (filters != null)
           {
         ...
         public  QuotationFileQuery ByQuotationIdWithfilter(int quotationid, IEnumerable<filterRule> filters)
         {
