...
/// </summary>
   public class ProductFileQuery:QueryObject<ProductFile>
   {
		public ProductFileQuery Withfilter(IEnumerable<filterRule> filters)
        {
           if (filters != null)
           {
         ...
         public  ProductFileQuery ByProductIdWithfilter(int productid, IEnumerable<filterRule> filters)
         {
