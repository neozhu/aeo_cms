...
{
/// <summary>
/// File: CustomerCommunicationQuery.cs
/// Purpose: easyui datagrid filter query 
/// Created Date: 2020/7/3 13:57:34
/// Author: neo.zhu
/// Tools: SmartCode MVC5 Scaffolder for Visual Studio 2017
/// Copyright (c) 2012-2018 All Rights Reserved
/// </summary>
   public class CustomerCommunicationQuery:QueryObject<CustomerCommunication>
   {
		public CustomerCommunicationQuery Withfilter(IEnumerable<filterRule> filters)
        {
           if (filters != null)
           {
               foreach (var rule in filters)
               {
						...
						if (rule.field == "CommType"  && !string.IsNullOrEmpty(rule.value))
						{
							And(x => x.CommType.Contains(rule.value));
						}
						...
						if (rule.field == "RefUsers"  && !string.IsNullOrEmpty(rule.value))
						{
							And(x => x.RefUsers.Contains(rule.value));
						}
         ...
         public  CustomerCommunicationQuery ByCustomerIdWithfilter(int customerid, IEnumerable<filterRule> filters)
         {
