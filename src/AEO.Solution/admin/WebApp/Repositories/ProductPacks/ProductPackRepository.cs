...
/// </summary>
  public static class ProductPackRepository  
    {
                 public static async Task<IEnumerable<ProductPack>> GetByProductIdAsync(this IRepositoryAsync<ProductPack> repository, int productid)
          => await repository
                .Queryable()
