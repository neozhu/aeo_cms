		...
		public CategoryQuery Withfilter(IEnumerable<filterRule> filters)
        {
           if (filters != null)
           {
               foreach (var rule in filters)
               {
						...
						if (rule.field == "Icon"  && !string.IsNullOrEmpty(rule.value))
						{
							And(x => x.Icon.Contains(rule.value));
						}
         ...
         public  CategoryQuery ByParentIdWithfilter(int parentid, IEnumerable<filterRule> filters)
         {
