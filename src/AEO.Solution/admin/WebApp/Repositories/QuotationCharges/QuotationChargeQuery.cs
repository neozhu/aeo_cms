...
{
/// <summary>
/// File: QuotationChargeQuery.cs
/// Purpose: easyui datagrid filter query 
/// Created Date: 2020/8/27 13:52:28
/// Author: neo.zhu
/// Tools: SmartCode MVC5 Scaffolder for Visual Studio 2017
/// Copyright (c) 2012-2018 All Rights Reserved
/// </summary>
   public class QuotationChargeQuery:QueryObject<QuotationCharge>
   {
		public QuotationChargeQuery Withfilter(IEnumerable<filterRule> filters)
        {
           if (filters != null)
           {
         ...
         public  QuotationChargeQuery ByQuotationIdWithfilter(int quotationid, IEnumerable<filterRule> filters)
         {
